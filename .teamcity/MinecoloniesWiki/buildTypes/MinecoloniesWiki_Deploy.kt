...
object MinecoloniesWiki_Deploy : BuildType({
    ...
    steps {
        ...
        script {
            ...
            workingDir = "chart"
            scriptContent = "helm upgrade --atomic -i -n minecolonies-wiki --set image.tag=${MinecoloniesWiki_BuildAndPublish.depParamRefs.buildNumber} minecolonies-wiki ./wiki"
        }
    }
