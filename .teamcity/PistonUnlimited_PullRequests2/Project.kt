package PistonUnlimited_PullRequests2

import PistonUnlimited_PullRequests2.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("PistonUnlimited_PullRequests2")
    name = "Pull Requests"
    description = "All open pull requests"

    buildType(PistonUnlimited_PullRequests2_BuildAndTest)
    buildType(PistonUnlimited_PullRequests2_CommonBuildCounter)
