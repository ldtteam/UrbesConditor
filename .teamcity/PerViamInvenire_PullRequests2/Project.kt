package PerViamInvenire_PullRequests2

import PerViamInvenire_PullRequests2.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("PerViamInvenire_PullRequests2")
    name = "Pull Requests"
    description = "All open pull requests"

    buildType(PerViamInvenire_PullRequests2_CommonBuildCounter)
    buildType(PerViamInvenire_PullRequests2_BuildAndTest)
