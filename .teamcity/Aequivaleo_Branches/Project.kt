package Aequivaleo_Branches

import Aequivaleo_Branches.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("Aequivaleo_Branches")
    name = "Branches"
    description = "All none release branches."

    buildType(Aequivaleo_Branches_Build)
    buildType(Aequivaleo_Branches_Common)
