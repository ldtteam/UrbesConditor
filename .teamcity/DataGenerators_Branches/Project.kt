package DataGenerators_Branches

import DataGenerators_Branches.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("DataGenerators_Branches")
    name = "Branches"
    description = "All none release branches."

    buildType(DataGenerators_Branches_Common)
    buildType(DataGenerators_Branches_Build)
