package DataGenerators_PullRequests2

import DataGenerators_PullRequests2.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("DataGenerators_PullRequests2")
    name = "Pull Requests"
    description = "All open pull requests"

    buildType(DataGenerators_PullRequests2_BuildAndTest)
    buildType(DataGenerators_PullRequests2_CommonBuildCounter)
