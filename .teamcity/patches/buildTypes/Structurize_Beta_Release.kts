...
To apply the patch, create a buildType with id = 'Structurize_Beta_Release'
in the project with id = 'Structurize_Beta', and delete the patch script.
*/
create(RelativeId("Structurize_Beta"), BuildType({
    templates(RelativeId("BuildWithRelease"))
    id("Structurize_Beta_Release")
    name = "Release"
