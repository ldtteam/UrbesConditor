...
To apply the patch, create a buildType with id = 'Structurize_Alpha_Release'
in the project with id = 'Structurize_Alpha', and delete the patch script.
*/
create(RelativeId("Structurize_Alpha"), BuildType({
    templates(RelativeId("BuildWithRelease"))
    id("Structurize_Alpha_Release")
    name = "Release"
