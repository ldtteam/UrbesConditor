package SmithsCore_PullRequests

import SmithsCore_PullRequests.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("SmithsCore_PullRequests")
    name = "Pull Requests"
    description = "All open pull requests"
    archived = true

    buildType(SmithsCore_PullRequests_BuildAndTest)
    buildType(SmithsCore_PullRequests_CommonBuildCounter)
