package BlockOut_Branches

import BlockOut_Branches.buildTypes.*
import jetbrains.buildServer.configs.kotlin.v2019_2.*
import jetbrains.buildServer.configs.kotlin.v2019_2.Project

object Project : Project({
    id("BlockOut_Branches")
    name = "Branches"
    description = "All none release branches."

    buildType(BlockOut_Branches_CommonBuildCounter)
    buildType(BlockOut_Branches_Build)
