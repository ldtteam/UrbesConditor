package JVoxelizer_Alpha.buildTypes
...
object JVoxelizer_Alpha_Release : BuildType({
    ...
    steps {
        gradle {
            name = "Setup"
            id = "RUNNER_83"
            tasks = "clean setupCiWorkspace --parallel --stacktrace"
            buildFile = "build.gradle"
            gradleParams = "-Pgradle.cache.push=true -Dorg.gradle.daemon=false"
        ...
        gradle {
            ...
            buildFile = "build.gradle"
            gradleParams = "-Dorg.gradle.daemon=false -Pgradle.cache.push=true"
            useGradleWrapper = false
